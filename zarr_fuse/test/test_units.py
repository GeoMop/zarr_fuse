...
from zarr_fuse.units import create_quantity, DateTimeUnit, ureg


def test_create_quantity():
    from datetime import timezone, timedelta
    # Numeric conversion correctness
    q_numeric = create_quantity(['1', '2.5', '3'], 'meter')
    ...
    # Test .to()
    target = DateTimeUnit(tick='m', tz='+02:00', dayfirst=False, yearfirst=False)
    ...
    # Test __add__
    addition = ureg.Quantity(90, 'minute')
